...
echo ""
echo "📋 Note: This template includes automatic version bumping"
echo "   Versions are automatically incremented when merging to master/main branch"
echo "   See docs/VERSION_BUMPING.md for more details"